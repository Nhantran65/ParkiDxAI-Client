...
const AccountInformationCard = () => {
    const { t } = useTranslation(['bkd.user', 'pages.doctor.details']);
    ...
    const form = useForm<IUpdateUserData>({
        defaultValues: {
            ...
            role: doctor?.role || UserRole.Doctor,
        },
    ...
    return (
            ...
            title={
                <Flex justify="space-between">
                    <Typography.Title level={5}>
                        {t('tab.details.account_information', { ns: 'pages.doctor.details' })}
                    </Typography.Title>
        ...
        >
            ...
            >
                ...
                >
                    {isEditing ? <InputUpload /> : <InputUpload readOnly />}
                </Form.ItemControl>
                <Form.ItemControl
                    control={control}
                    name="email"
