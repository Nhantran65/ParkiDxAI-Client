    ...
    (
        ...
        const onChange = useCallback(
            (event: ChangeEvent<HTMLInputElement>) => {
                const formattedNumber = selectedRef.current
                    ? event.target.value
                    : getFormattedNumber(event.target.value, pattern);
                ...
                switch (valueType) {
                    case 'raw':
                        handleChange(getRawValue(phoneMetadata), event);
                    ...
                    {countriesList.map(([iso, name, dial, pattern]) => {
                        ...
                        return (
                            <Select.Option
                                ...
                                children={
                                    <div className={`${prefixCls}-phone-input-select-item`}>
                                        <div className={`flag ${iso}`} />
        ...
        return (
            <div
                className={`${prefixCls}-phone-input-wrapper`}
...
export type { locale, PhoneInputProps, PhoneNumber };
